...
import { a as subscribe, n as noop, c as compute_rest_props, o as onDestroy } from "../../chunks/lifecycle.js";
...
const Layout = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  return `<div class="p-4">${slots.default ? slots.default({}) : ``}</div> ${validate_component(Sonner_1, "Toaster").$$render($$result, {}, {}, {})}`;
});
export {
  Layout as default
};
